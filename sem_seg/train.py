...
parser.add_argument('--num_keypoints', type=int, default=256, help='Number of keypoints [default: 128]')
...
DATA_PATH = '/home/wuweikun/xxx/data/scannet/'
    ...
    with tf.Graph().as_default():
        ...
        for epoch in range(MAX_EPOCH):
            ...
            if epoch % 10 == 0:
                ...
                log_string("Model saved in file: %s" % save_path)
            log_string('#######best eval point accuracy##########: %f'% best_acc)
